...
class TestAppRun < Minitest::Test
  ...
  def setup
    stdin.stubs(:gets).returns('kane', "q")
  ...
  def test_adding_project
    stub_input('kane', 'a', 'Cat Husbandry', 'q')
    app.run
  ...
  def test_edit_project_that_does_not_exist
    stub_input('kane', 'a', 'House work', 'e', 'House Work', 'q')
    app.run
  ...
  def test_edit_project_by_position_number
    stub_input('kane', 'a', 'House work', 'e', '1', 'q')
    app.run
  ...
  def test_changing_project_name
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'c', 'Chores', 'b', 'ls', 'q')
    app.run
  ...
  def test_changing_project_name_that_does_not_exist
    stub_input('kane', 'a', 'House work', 'e', 'House Work', 'ls', 'q')
    app.run
    last_section = output.split("Listing projects").last
  ...
  def test_changing_project_name_by_position
    stub_input('kane', 'a', 'House work', 'e', '1', 'c', 'Chores', 'b', 'ls', 'q')
    app.run
    last_section = output.split("Listing projects").last
    assert_includes output, "Changed project name from 'House work' to 'Chores'"
    refute_includes last_section, "House work"
  ...
  def test_adding_a_task
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'q');
    app.run
  ...
  def test_listing_a_task_after_adding_a_task
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'ls', 'q');
    app.run
  ...
  def test_editing_a_task_that_does_not_exist
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'defrost freezer', 'e', 'clean out the freezer', 'q')
    app.run
    assert_includes output, "Task doesn't exist: 'clean out the freezer'"
  end

  def test_editing_a_task_that_does_exist
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'e', 'clean out the freezer', 'clean out fridge', 'ls', 'q')
    app.run
  ...
  def test_editing_a_task_by_position
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'e', '1', 'clean out fridge', 'ls', 'q')
    app.run
    assert_includes output, "Changed task name from 'clean out the freezer' to 'clean out fridge'"
    last_section = output.split("Listing tasks").last
    refute_includes last_section, "clean out the freezer"
  ...
  def test_delete_task_when_task_doesnt_exist
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'd', 'eat defrosting food', 'q')
    app.run
    assert_includes output, "Task doesn't exist: 'eat defrosting food'"
  end

  def test_delete_task_that_exists
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'd', 'clean out the freezer', 'q')
    app.run
    assert_includes output, "Deleted task: 'clean out the freezer'"
  end

  def test_delete_task_by_position
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'd', '1', 'ls', 'q')
    app.run
    assert_includes output, "Deleted task: 'clean out the freezer'"
  end

  def test_finish_task_when_task_doesnt_exist
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'f', 'eat defrosting food', 'q')
    app.run
    assert_includes output, "Task doesn't exist: 'eat defrosting food'"
  end

  def test_finish_task_that_exists
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'f', 'clean out the freezer', 'ls', 'q')
    app.run
  ...
  def test_finish_task_by_position
    stub_input('kane', 'a', 'House work', 'e', 'House work', 'a', 'clean out the freezer', 'f', '1', 'q')
    app.run
    assert_includes output, "Finished task: 'clean out the freezer'"
  end
